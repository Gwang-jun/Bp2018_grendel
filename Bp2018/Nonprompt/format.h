...
#define ELECTRON_MASS 0.0005109989461 //0.0005
#define MUON_MASS   0.1056583745 //0.10565837
#define PION_MASS   0.13957061 //0.13957018
#define KAON_MASS   0.493677 //0.493677
#define KSHORT_MASS 0.497611 //0.497614
#define KSTAR_MASS  0.89555 //0.89594
#define PHI_MASS    1.019461 //1.019455
#define JPSI_MASS   3.096900 //3.096916
#define PSI2S_MASS  3.686097 //3.686109
#define PROTON_MASS 0.9382720813 //0.9383
#define D0_MASS 1.86483 //1.8648
#define DSTAR_MASS 2.01026 //2.01028
#define DPLUS_MASS 1.86965 //1.8696
#define DSUBS_MASS 1.96834 //1.9683
...
class MuonInfoBranches{//{{{
 public:
  ...
  bool     innerTrackQuality    [MAX_MUON];
  ...
  float MuTrgMatchFilterTrgObjE;
  float MuTrgMatchFilterTrgObjPt;
  float MuTrgMatchFilterTrgObjEta;
  float MuTrgMatchFilterTrgObjPhi;
  ...
  void regTree(TTree *root, bool detailMode = false){//{{{
    ...
    root->Branch("MuonInfo.MuTrgMatchFilterTrgObjE", &MuTrgMatchFilterTrgObjE, "MuonInfo.MuTrgMatchFilterTrgObjE/F");
    root->Branch("MuonInfo.MuTrgMatchFilterTrgObjPt", &MuTrgMatchFilterTrgObjPt, "MuonInfo.MuTrgMatchFilterTrgObjPt/F");
    root->Branch("MuonInfo.MuTrgMatchFilterTrgObjEta", &MuTrgMatchFilterTrgObjEta, "MuonInfo.MuTrgMatchFilterTrgObjEta/F");
    root->Branch("MuonInfo.MuTrgMatchFilterTrgObjPhi", &MuTrgMatchFilterTrgObjPhi, "MuonInfo.MuTrgMatchFilterTrgObjPhi/F");
...
class TrackInfoBranches{//{{{
 public:
  ...
  void regTree(TTree *root, bool detailMode = false){//{{{
    ...
    root->Branch("TrackInfo.dz1"           ,dzPV           ,"TrackInfo.dz1[TrackInfo.size]/F"		);
    root->Branch("TrackInfo.dxy1"          ,dxyPV          ,"TrackInfo.dxy1[TrackInfo.size]/F"		);
  ...
  void setbranchadd(TTree *root, bool detailMode = false){//{{{
    ...
    root->SetBranchAddress("TrackInfo.dz1"          , dzPV        );
    root->SetBranchAddress("TrackInfo.dxy1"         , dxyPV       );
