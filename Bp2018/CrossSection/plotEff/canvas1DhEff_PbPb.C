...
//=========  (Wed Sep 25 16:56:26 2019) by ROOT version 6.16/00
   TCanvas *canvas1D = new TCanvas("canvas1D", "",0,0,600,600);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   canvas1D->SetHighLightColor(2);
   canvas1D->Range(-8.125001,-0.125,73.125,1.125);
   ...
   TH2F *hemptyEff__1 = new TH2F("hemptyEff__1","",50,0,65,10,0,1);
   ...
   TH1D *hEff__2 = new TH1D("hEff__2","",8, xAxis1);
   hEff__2->SetBinContent(1,0.0006130466);
   hEff__2->SetBinContent(2,0.004173349);
   hEff__2->SetBinContent(3,0.03005797);
   hEff__2->SetBinContent(4,0.08652773);
   hEff__2->SetBinContent(5,0.1527663);
   hEff__2->SetBinContent(6,0.2197896);
   hEff__2->SetBinContent(7,0.252492);
   hEff__2->SetBinContent(8,0.2560051);
   hEff__2->SetBinContent(9,0.2370768);
   hEff__2->SetBinError(1,8.998655e-05);
   hEff__2->SetBinError(2,0.0002418926);
   hEff__2->SetBinError(3,0.0006880623);
   hEff__2->SetBinError(4,0.001429458);
   hEff__2->SetBinError(5,0.001893232);
   hEff__2->SetBinError(6,0.003371916);
   hEff__2->SetBinError(7,0.004627406);
   hEff__2->SetBinError(8,0.005044675);
   hEff__2->SetBinError(9,0.00369494);
   hEff__2->SetEntries(15603.56);
   hEff__2->SetStats(0);
