...
//=========  (Wed Sep 18 11:19:27 2019) by ROOT version 6.16/00
   ...
   hPtSigma__2->SetBinContent(1,1.462074e+07);
   hPtSigma__2->SetBinContent(2,2837700);
   hPtSigma__2->SetBinContent(3,704946.9);
   hPtSigma__2->SetBinContent(4,87422.55);
   hPtSigma__2->SetBinError(1,1679456);
   hPtSigma__2->SetBinError(2,176846.8);
   hPtSigma__2->SetBinError(3,48853.14);
   hPtSigma__2->SetBinError(4,5009.542);
   hPtSigma__2->SetEntries(116.7);
   ...
   Graph_gaeCrossSyst3001->SetMinimum(72052.67);
   Graph_gaeCrossSyst3001->SetMaximum(1.847033e+07);
