...
//=========  (Mon Sep 30 23:28:34 2019) by ROOT version 6.16/00
   ...
   hemptySigma__1->Draw("");
   Double_t xAxis1[2] = {5, 50}; 
   
   TH1D *hPtSigma__2 = new TH1D("hPtSigma__2","",1, xAxis1);
   hPtSigma__2->SetBinContent(1,776600.6);
   hPtSigma__2->SetBinError(1,54416.91);
   hPtSigma__2->SetEntries(203.6702);
   ...
   TH1F *Graph_gaeCrossSyst3001 = new TH1F("Graph_gaeCrossSyst3001","Graph",100,4.5,10.5);
   Graph_gaeCrossSyst3001->SetMinimum(595214.6);
   Graph_gaeCrossSyst3001->SetMaximum(957986.5);
