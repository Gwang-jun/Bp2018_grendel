...
double ppLumiUncertainty 	= 2.0;			// paper

// Point-to-point
double ppTrackingEfficiency 	= 4;   			// single track systematics from D* studies
//double PbPbTrackingEfficiency 	= 5;   		// single track systematics from D* studies, PAS
...
//double TAAUncertainty0to100HI = 8.9;	//PAS
//double TAAUncertainty0to100LO = 8.9;	//PAS
...
/*
  PbPbMesonSelection = new TH1D("PbPbMesonSelection","",nBins,ptBins);
  PbPbMesonSelection->SetBinContent(1, 27.6);
  ...
  PbPbSignalExtraction->SetBinContent(1, 22.8);
  PbPbSignalExtraction->SetBinContent(2, 4.81);
  PbPbSignalExtraction->SetBinContent(3, 5.45);
  PbPbSignalExtraction->SetBinContent(4, 9.26);
  PbPbSignalExtraction->SetBinContent(5, 2.18);
  PbPbSignalExtraction->SetBinContent(6, 14.1);
  PbPbSignalExtraction->SetBinContent(7, 4.50);
  */
